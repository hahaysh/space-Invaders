...
| 3. 점검 (1개) | **문서 PR을 먼저 main에 병합**, M1·M2·M3 이슈 등록·M1 새 세션 |
| 4. 구현 (3개) | M1·M2·M3별 이슈·세션·PR, 각 PR 병합 후 다음 단계 시작 |
...
M1·M2·M3 이슈는 03-01에서 등록하고 각 단계에서 재사용합니다.
각 구현 단계와 후속 개선은 직전 PR이 병합된 최신 main에서 새 세션으로 시작합니다.
