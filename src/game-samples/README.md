...
> 두 샘플은 구현·로컬 자동 검증을 마쳤으며 해당 샘플의 원격 배포 근거는 없습니다. 별도 demo01은 이전 25개 실습과 실제 공개 배포까지 완료했습니다. **현재 v2/demo02 리허설은 대기 중**입니다.
...
demo01과 이 두 샘플은 이번 v2 문서 개편의 수정 대상이 아닙니다.
