...
[08 난이도 선택](../../docs/08-01-difficulty-design.md)과 [09 목숨 3개](../../docs/09-01-lives-design.md)는 일시정지 개선 이후에 진행하는 후속 실습입니다. 두 샘플 모두 이 기능을 포함하지 않으며, 해당 확장의 구현·실행 리허설은 미수행입니다. 참가자가 자신의 게임에서 새 변경 요청을 승인하고 구현하도록 작성한 문서이며, 위 테스트 수를 확장 기능의 통과 근거로 사용하지 않습니다.
