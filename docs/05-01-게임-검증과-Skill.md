...
App **Interactive**에서 원격 main과 M1·M2·M3 PR 병합을 확인하고 요청합니다.

**모드: Interactive**

```text
최신 main에 기본 게임·README·App 설정이 병합됐는지 확인해 줘.
M1·M2·M3 PR이 모두 병합됐는지 확인하고, 미완료이면 상태를 알려 주고 멈춰 줘.
...
```text
PRD·TRD·기본 게임 M1·M2·M3 이슈·실제 package scripts와 기존 테스트를 읽어 줘.
